...
:: 任务3：每周六 01:00 自动生成并发送周报
schtasks /create /tn "USCSSWeeklyReport" /tr "%NODE% \"%SKILL_DIR%\auto-report.js\"" /sc WEEKLY /d SAT /st 01:00 /f /rl HIGHEST
echo [OK] 每周六 01:00 周报自动发送任务已注册
...
echo   周六 01:00  — 自动生成报告（含你的回复内容）+ 推 Pages + 飞书通知
echo.
echo 初始配置：
